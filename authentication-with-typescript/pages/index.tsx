          ...
          <div className='container px-6 py-3 mx-auto lg:flex lg:justify-between lg:items-center'>
            ...
            <div className='items-center lg:flex'>
              <div className='flex flex-col lg:flex-row lg:mx-6'>
                ...
                {loggedIn && <h2 onClick={logOutHandler}> Log Out</h2>}
              </div>
          ...
          <div className='items-center lg:flex'>
            ...
            <div className='flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2'>
              <Image
                ...
                src='https://images.pexels.com/photos/994523/pexels-photo-994523.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'
